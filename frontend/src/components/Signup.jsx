        ...
        <div className="signup">
            <div className="form-container">
                <form action="" className="form">
                    ...
                    <input type="password" name="password" placeholder="Password" value={password} className="input" onChange={(event)=>{
                    ...
                    <input type="submit" value={"Sign Up"} className="signUpButton" onClick={()=>{
                        postData()
                    }}/>
                </form>
                <div className="form2">
